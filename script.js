function myFunction() {
  ...
  let ebtotal = eval(
    (parseFloat((ebu1 = document.validform.ebu1.value)) +
      parseFloat((ebu2 = document.validform.ebu2.value))) /
      2 +
      parseFloat((ebfinal = document.validform.ebfinal.value))
  );
  ...
  let iptotal = eval(
    (parseFloat(document.validform.Ipu1.value) +
      parseFloat(document.validform.Ipu2.value)) /
      2 +
      parseFloat(document.validform.Ipfinal.value)
  );
  ...
  let setotal = eval(
    (parseFloat(document.validform.Seu1.value) +
      parseFloat(document.validform.Seu2.value)) /
      2 +
      parseFloat(document.validform.Sefinal.value)
  );
  ...
  let mttotal = eval(
    (parseFloat(document.validform.Mtu1.value) +
      parseFloat(document.validform.Mtu1.value)) /
      2 +
      parseFloat(document.validform.Mtfinal.value)
  );
  ...
  let cnstotal = eval(
    (parseFloat(document.validform.Cnu1.value) +
      parseFloat(document.validform.Cnu1.value)) /
      2 +
      parseFloat(document.validform.Cnfinal.value)
  );
